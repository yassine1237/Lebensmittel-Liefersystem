...
public class OrderController {
	...
	public ResponseEntity<List<Order>> getRecentOrdersByRestaurant(@RequestHeader("Restaurant-Id") Long restaurantId)
			throws OrderException, RestaurantException {
		List<Order> recentOrders = orderService.getRecentOrdersOfRestaurant(restaurantId);
